...
namespace Directree.Logic.Analytics
{
    public class AssetClass : INotifyPropertyChanged
    {
        ...
        public static List<AssetClass> ConstructTestData1()
        {
            List<AssetClass> assetClasses = new List<AssetClass>();

            assetClasses.Add(new AssetClass() { Class = "Cash1", Fund = 1.56, Total = 1.56, Benchmark = 4.82 });
            assetClasses.Add(new AssetClass() { Class = "Bonds1", Fund = 2.92, Total = 2.92, Benchmark = 17.91 });
            assetClasses.Add(new AssetClass() { Class = "Real Estate1", Fund = 13.24, Total = 2.40, Benchmark = 0.04 });
            assetClasses.Add(new AssetClass() { Class = "Foreign Currency1", Fund = 16.44, Total = 16.44, Benchmark = 8.05 });
            assetClasses.Add(new AssetClass() { Class = "Stocks; Domestic1", Fund = 27.57, Total = 27.57, Benchmark = 38.24 });
            assetClasses.Add(new AssetClass() { Class = "Stocks; Foreign1", Fund = 50.03, Total = 50.03, Benchmark = 30.93 });
